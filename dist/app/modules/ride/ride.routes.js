...
router.get('/history', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.RIDER, auth_interface_1.UserRoles.ADMIN]), ride_controller_1.RideController.getRideHistory);
router.get('/driver-history', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.DRIVER, auth_interface_1.UserRoles.ADMIN]), ride_controller_1.RideController.getDriverHistory);
router.get('/:rideId', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.RIDER, auth_interface_1.UserRoles.ADMIN, auth_interface_1.UserRoles.DRIVER]), ride_controller_1.RideController.getSingleRide);
...
router.patch('/:id/status', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.DRIVER, auth_interface_1.UserRoles.RIDER]), (0, validateRequest_middleware_1.default)(ride_validation_1.updateRideStatusSchema), ride_controller_1.RideController.updateRideStatus);
